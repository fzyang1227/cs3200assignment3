...
public class CourseDao {
    ...
    public static void main(String[] args) {
        ...
        // update courses and print new courses
        Course course = new Course(123, "CS2222");
        Integer status = dao.updateCourse(123, course);

        List<Course> up_courses = dao.findAllCourses();
        for (Course c : up_courses) {
            System.out.println(c);
        }
        ...
        // insert new record and print out status and new record
